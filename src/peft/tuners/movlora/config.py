...
class MovLoraConfig(LoraConfig):
    ...
    router_temperature: float = field(default=1.0, metadata={"help": "Softmax temperature for expert routing."}) # Not in original approach, added for stability check. Keep at 1.0 for original MoV-LoRA
