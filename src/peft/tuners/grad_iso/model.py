...
class GradIsoModel(BaseTuner):
    ...
    def _create_and_replace(self, lora_config, adapter_name, target, target_name, parent, current_key):
        kwargs = {
            ...
            "num_partitions": lora_config.grad_iso_num_partitions,
            "grad_iso_inference_mode": lora_config.grad_iso_inference_mode,
    ...
    def _mark_only_adapters_as_trainable(self, model):
        for n, p in model.named_parameters():
            if "lora_" in n or "partition_" in n:
