...
class MoELoraConfig(LoraConfig):
    ...
    task_num: int = field(default=1, metadata={"help": "Number of routing ids (e.g., language ids) used by the gate."})
    task_embedding_dim: int = field(default=64, metadata={"help": "Routing-id embedding dimension for the shared gate."})
