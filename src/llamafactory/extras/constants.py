...
METHODS = ["full", "freeze", "lora", "oft", "cola", "hydralora", "adamole", "moelora", "movlora", "mola", "moelpr"]

MOD_SUPPORTED_MODELS = {"bloom", "falcon", "gemma", "llama", "mistral", "mixtral", "phi", "starcoder2"}

MULTIMODAL_SUPPORTED_MODELS = set()

PEFT_METHODS = {"lora", "oft", "cola", "hydralora", "adamole", "moelora", "movlora", "mola", "moelpr"}
